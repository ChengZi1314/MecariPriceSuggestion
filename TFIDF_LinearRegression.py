...
def main():
    ...
    train = pd.read_table(r'D:\Alibaba game\MercariPriceSuggestion\train.tsv', engine='c')
    test = pd.read_table(r'D:\Alibaba game\MercariPriceSuggestion\test.tsv', engine='c')
    ...
    model = lgb.train(params, train_set=d_train, num_boost_round=10000, valid_sets=watchlist,early_stopping_rounds=1000, verbose_eval=1000)
    ...
    model = lgb.train(params2, train_set=d_train2, num_boost_round=5000, valid_sets=watchlist2,early_stopping_rounds=50, verbose_eval=500)
